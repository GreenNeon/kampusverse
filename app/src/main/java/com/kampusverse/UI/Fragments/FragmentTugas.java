...
import com.kampusverse.UI.Adapter.AdapterTugas;
...
public class FragmentTugas extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frgtugas,container,false);
        ...
        adapter = new AdapterTugas(sdata.GetKoleksiTugas(), getContext());
